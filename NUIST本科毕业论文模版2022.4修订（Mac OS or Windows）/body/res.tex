...
\begin{figure}[htbp]
    \center
    \subfigure[t=120]{\label{46a}
    \includegraphics[width=0.4\textwidth]{figs/chap04/04.png}
    }\subfigure[t=240]{\label{46b}
    \includegraphics[width=0.4\textwidth]{figs/chap04/01.png}
    }
    \\
    \subfigure[t=480]{\label{46c}
    \includegraphics[width=0.4\textwidth]{figs/chap04/07.png}
    }\subfigure[t=720]{\label{46d}
    \includegraphics[width=0.4\textwidth]{figs/chap04/10.png}
    }
...
\begin{figure}[htbp]
    \center
    \subfigure[t=120]{\label{47a}
    \includegraphics[width=0.45\textwidth]{figs/chap04/05.png}
    }\subfigure[t=240]{\label{47b}
    \includegraphics[width=0.45\textwidth]{figs/chap04/02.png}
    }
    \\
    \subfigure[t=480]{\label{47c}
    \includegraphics[width=0.45\textwidth]{figs/chap04/08.png}
    }\subfigure[t=720]{\label{47d}
    \includegraphics[width=0.45\textwidth]{figs/chap04/11.png}
    }
    \caption{系统时间-队列长度图}\label{fig47}
\end{figure}

系统的时间-等待时间图：
\begin{figure}[htbp]
    \center
    \subfigure[t=120]{\label{48a}
    \includegraphics[width=0.45\textwidth]{figs/chap04/06.png}
    }\subfigure[t=240]{\label{48b}
    \includegraphics[width=0.45\textwidth]{figs/chap04/03.png}
    }
    \\
    \subfigure[t=480]{\label{48c}
    \includegraphics[width=0.45\textwidth]{figs/chap04/09.png}
    }\subfigure[t=720]{\label{48d}
    \includegraphics[width=0.45\textwidth]{figs/chap04/12.png}
    }
    \caption{系统时间-等待时间图}\label{fig48}
\end{figure}

在新的调度方案下，由图~\ref{fig46}~到~\ref{fig48}~的模拟结果，可见系统系统可以长期保持稳定运行且不产生阻塞，
乘客的平均等待时间也有所下降。该可行解是一个有效的优化方案。